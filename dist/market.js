...
const listingCollected=new Date(m.collected_at||0),listingAgeDays=isNaN(listingCollected)?999:(Date.now()-listingCollected.getTime())/86400000,listingFresh=listingAgeDays<=10;
